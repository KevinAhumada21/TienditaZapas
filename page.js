        ...
        <Modal.Body>
          {selectedZapatilla && (
            <div id="carouselImages" className="carousel slide" data-ride="carousel">
              ...
              <a className="carousel-control-prev" href="#carouselImages" role="button" data-slide="prev" onClick={() => {
              ...
              <a className="carousel-control-next" href="#carouselImages" role="button" data-slide="next" onClick={() => {
                const carousel = document.querySelector('#carouselImages');
                const carouselInstance = new window.bootstrap.Carousel(carousel);
